...
class MobileAuditor:
    ...
    def audit_file(self, filepath: str) -> None:
        ...
        if is_react_native:
            ...
            has_large_title = bool(re.search(r'fontSize:\s*34|largeTitle|font-weight:\s*["\']?bold', content))  # noqa: F841
            has_title_1 = bool(re.search(r'fontSize:\s*28', content))  # noqa: F841
            has_headline = bool(re.search(r'fontSize:\s*17.*semibold|headline', content))  # noqa: F841
            has_body = bool(re.search(r'fontSize:\s*17.*regular|body', content))  # noqa: F841
        ...
        if is_react_native:
            ...
            has_title_material = bool(re.search(r'fontSize:\s*2[12][0-9].*medium|title', content))  # noqa: F841
            has_body_material = bool(re.search(r'fontSize:\s*1[456].*regular|body', content))  # noqa: F841
        ...
        light_colors = re.findall(r'#[0-9A-Fa-f]{6}|rgba?\([^)]+\)', content)  # noqa: F841
        ...
        if is_react_native:
            ...
            has_systemBackground = bool(re.search(r'systemBackground|\.systemBackground', content))  # noqa: F841
        ...
        testing_tools = []
        if has_jest: testing_tools.append('Jest')  # noqa: E701
        if has_rntl: testing_tools.append('RNTL')  # noqa: E701
        if has_detox: testing_tools.append('Detox')  # noqa: E701
        if has_maestro: testing_tools.append('Maestro')  # noqa: E701
        ...
        has_debugger = bool(re.search(r'debugger|__DEV__|React\.DevTools', content))  # noqa: F841
