...
> Before writing any code, you MUST read **[docs/PROTOCOLS.md](../../docs/PROTOCOLS.md)**.
> This file contains the "Blindagem P1" (JS Safety) and UI Integrity rules that are non-negotiable for this project.
