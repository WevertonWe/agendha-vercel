...
def get_biomas_summary():
    ...
    Busca dados financeiros e de beneficiários na nuvem.
    """
    ...
    # Null Safety aplicado diretamente no cálculo
...
def get_progresso_bioma(projeto_slug: str):
    ...
    """
    # Como as tabelas são dinâmicas, buscamos dados relacionados
    summary = get_biomas_summary()
    # Implementação futura baseada em metas específicas de cada bioma
    return {
        "slug": projeto_slug,
        "status": "Em Execução",
